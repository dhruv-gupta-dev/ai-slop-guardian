...
async def generate_review(request: ReviewRequest):
    ...
    system_prompt = (
        ...
        f"PR Context - Title: {request.pr_title} | Labels: {labels_str}\n\n"
        "CRITICAL RULE:\n"
        "If the PR title starts with 'chore', 'refactor', or 'style', or contains "
        "linting-related labels, you must assume the removal of unused imports and "
        "type changes are intentional refactors. Do not flag them as Potential Bugs."
    )
    user_prompt = (
